...
async def fa(ctx):
	...
	owner_vote_channel = bot.get_channel("630426017126809610")
	...
	vote = (f"{ctx.message.author.mention} voted for ChiefJack!")
	await bot.send_message(owner_vote_channel, vote)
...
async def fb(ctx):
	...
	survivor = (f"{ctx.message.author.mention} made it out of the trail alive...")
	await bot.send_message(survivor_channel, survivor)
	vote = (f"{ctx.message.author.mention} voted for StrikeKing22!")
	await bot.send_message(owner_vote_channel, vote)
	message = (f"Well done, that's correct! Now have a look for halloween-trail-end and thanks for playing! (A witch will brew this message out of extinction in approx. 30 seconds)")
	send = await bot.send_message(ctx.message.channel, message)
	await asyncio.sleep(30)
...
async def fc(ctx):
	...
	survivor = (f"{ctx.message.author.mention} made it out of the trail alive...")
	await bot.send_message(survivor_channel, survivor)
	vote = (f"{ctx.message.author.mention} voted for Sequex!")
	await bot.send_message(owner_vote_channel, vote)
	message = (f"Well done, that's correct! Now have a look for halloween-trail-end and thanks for playing! (A witch will brew this message out of extinction in approx. 30 seconds)")
	send = await bot.send_message(ctx.message.channel, message)
	await asyncio.sleep(30)
...
async def fd(ctx):
	...
	survivor = (f"{ctx.message.author.mention} made it out of the trail alive...")
	await bot.send_message(survivor_channel, survivor)
	vote = (f"{ctx.message.author.mention} voted for Chlorines!")
	await bot.send_message(owner_vote_channel, vote)
	message = (f"Well done, that's correct! Now have a look for halloween-trail-end and thanks for playing! (A witch will brew this message out of extinction in approx. 30 seconds)")
	send = await bot.send_message(ctx.message.channel, message)
	await asyncio.sleep(30)
...
async def fe(ctx):
	...
	survivor = (f"{ctx.message.author.mention} made it out of the trail alive...")
	await bot.send_message(survivor_channel, survivor)
	vote = (f"{ctx.message.author.mention} voted for Chaoz18!")
	await bot.send_message(owner_vote_channel, vote)
	message = (f"Well done, that's correct! Now have a look for halloween-trail-end and thanks for playing! (A witch will brew this message out of extinction in approx. 30 seconds)")
	send = await bot.send_message(ctx.message.channel, message)
	await asyncio.sleep(30)
...
async def ff(ctx):
	...
	survivor = (f"{ctx.message.author.mention} made it out of the trail alive...")
	await bot.send_message(survivor_channel, survivor)
	vote = (f"{ctx.message.author.mention} voted for Veztix!")
	await bot.send_message(owner_vote_channel, vote)
	message = (f"Well done, that's correct! Now have a look for halloween-trail-end and thanks for playing! (A witch will brew this message out of extinction in approx. 30 seconds)")
	send = await bot.send_message(ctx.message.channel, message)
	await asyncio.sleep(30)
